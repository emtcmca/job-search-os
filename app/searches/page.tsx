import { createSavedSearchAction, runSavedSearchAction, toggleSavedSearchAction } from "@/app/searches/actions";
    ...
    >
      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_1.4fr]">
        <InfoCard
          ...
          body="This pass supports both tracked URLs and browser-assisted search sources. Google Jobs, LinkedIn, and Indeed can now run from the search keywords even when no tracked URLs are provided."
        >
          <form action={createSavedSearchAction} className="space-y-4">
            <input
              name="name"
              type="text"
